...
import { CloudIcon, KeyIcon, SettingsIcon, CodeIcon } from "lucide-react";
          ...
          <div className="mx-auto max-w-4xl mt-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  To access our API and Node.js library, you need to upgrade to
                  a premium account. Once upgraded, you'll receive your API key
                  to start integrating ffconvert into your projects.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button className="mt-4" variant="ringHover">
                  Upgrade to Premium
                </Button>
              </CardContent>
            </Card>
            <div className="grid gap-6 mt-8 md:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent>
                  Tailor the conversion process to your needs with custom
                  settings for each file type, allowing for precise control over
                  the output.
                </CardContent>
              </Card>
              <Card>
