  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto p-6">
        ...
        <p className="mb-4">
          Welcome to File Converter. These Terms of Service ("Terms") govern
          your use of our website located at [your-domain] (the "Service"). By
        ...
        <p className="mb-4">
          By using this Service, you agree to these Terms and our Privacy
          Policy. We reserve the right to update or modify these Terms at any
          time without prior notice. Your continued use of the Service
        ...
        <p className="mb-4">
          All content and materials provided on the Service, including but not
          limited to text, graphics, logos, and software, are the property of
          File Converter or its licensors and are protected by intellectual
          property laws.
        </p>
        <h2 className="text-2xl font-semibold mt-6 mb-4">
        ...
        <p className="mb-4">
          To the fullest extent permitted by law, File Converter shall not be
